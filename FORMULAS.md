...
| CONCAT | Text | 8 |
| CONCATENATE | Text | 7 |
| CORREL | Statistical | 21 |
| COS | Math & Trig | - |
| COSH | Math & Trig | - |
| COT | Math & Trig | - |
| COTH | Math & Trig | - |
| COUNT | Statistical | 8 |
| COUNTA | Statistical | 4 |
| COUNTBLANK | Statistical | 11 |
| COUNTIF | Statistical | 10 |
| COUNTIFS | Statistical | 3 |
| CSC | Math & Trig | - |
| CSCH | Math & Trig | - |
| DATE | Date & Time | 12 |
| DATEDIF | Date & Time | 9 |
...
| FIND | Text | 8 |
| FISHER | Statistical | 17 |
| FISHERINV | Statistical | 17 |
| FIXED | Text | - |
| FLOOR | Math & Trig | 3 |
| FORECAST | Statistical | 21 |
| FORECAST.LINEAR | Statistical | 3 |
| FV | Financial | 3 |
| GAMMALN | Statistical | 25 |
| GAMMALN.PRECISE | Statistical | 6 |
| GCD | Math & Trig | - |
| GEOMEAN | Statistical | 6 |
| HARMEAN | Statistical | 22 |
| HLOOKUP | Lookup & Reference | 5 |
| HOUR | Date & Time | - |
| IF | Logical | 47 |
| IFERROR | Logical | 19 |
| IFNA | Information | 12 |
| IFS | Logical | 2 |
| INDEX | Lookup & Reference | 14 |
| INDIRECT | Lookup & Reference | 35 |
| INT | Math & Trig | 2 |
| INTERCEPT | Statistical | 17 |
| IPMT | Financial | 2 |
| IRR | Financial | 2 |
| ISBLANK | Information | - |
| ISERR | Information | - |
...
| PROPER | Text | - |
| PV | Financial | 1 |
| QUARTILE | Statistical | 38 |
| QUOTIENT | Math & Trig | - |
| RADIANS | Math & Trig | - |
| RAND | Math & Trig | 3 |
| RANDBETWEEN | Math & Trig | 2 |
| RANK | Statistical | - |
| RATE | Financial | 1 |
| REPLACE | Text | - |
| REPT | Text | - |
...
| SUBTOTAL | Math & Trig | - |
| SUM | Statistical | 67 |
| SUMIF | Statistical | 10 |
| SUMIFS | Statistical | 7 |
| SUMPRODUCT | Statistical | 16 |
| SUMSQ | Statistical | - |
| SWITCH | Logical | 2 |
| TAN | Math & Trig | - |
| TANH | Math & Trig | - |
...
| TIME | Date & Time | 2 |
| TODAY | Date & Time | 4 |
| TRANSPOSE | Lookup & Reference | 21 |
| TRIM | Text | 6 |
| TRIMMEAN | Statistical | 24 |
| TRUNC | Math & Trig | - |
| TYPE | Information | - |
| UPPER | Text | 1 |
| VALUE | Text | 2 |
...
The following **265** Excel functions are not yet supported.
