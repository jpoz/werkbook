# xlsxwriter/03_conditional_aggregates

- Audit report: `../testdata/out/issues/xlsxwriter/03_conditional_aggregates.json`
- Diff count: `20`
- Category: `aggregate evaluation`
- Summary: Conditional aggregate outputs match the `exceljs` failure pattern and are currently all `0` on the dashboard cells that should contain totals.
