...
func init() {
	RegisterScalarLifted("ABS", NoCtx(fnABS))
	RegisterScalarLifted("ACOS", NoCtx(fnACOS))
	Register("ACOSH", NoCtx(fnACOSH))
	Register("ACOT", NoCtx(fnACOT))
	Register("ACOTH", NoCtx(fnACOTH))
	Register("ARABIC", NoCtx(fnARABIC))
	RegisterScalarLifted("ASIN", NoCtx(fnASIN))
	Register("ASINH", NoCtx(fnASINH))
	RegisterScalarLifted("ATAN", NoCtx(fnATAN))
	...
	RegisterScalarLifted("COS", NoCtx(fnCOS))
	RegisterScalarLifted("COSH", NoCtx(fnCOSH))
	...
	RegisterScalarLifted("EXP", NoCtx(fnEXP))
	RegisterScalarLifted("FACT", NoCtx(fnFACT))
	...
	RegisterScalarLifted("INT", NoCtx(fnINT))
	Register("LCM", NoCtx(fnLCM))
	RegisterScalarLifted("LN", NoCtx(fnLN))
	Register("LOG", NoCtx(fnLOG))
	RegisterScalarLifted("LOG10", NoCtx(fnLOG10))
	...
	RegisterScalarLifted("SIGN", NoCtx(fnSIGN))
	RegisterScalarLifted("SIN", NoCtx(fnSIN))
	RegisterScalarLifted("SINH", NoCtx(fnSINH))
	RegisterScalarLifted("SQRT", NoCtx(fnSQRT))
	...
	RegisterScalarLifted("TAN", NoCtx(fnTAN))
	RegisterScalarLifted("TANH", NoCtx(fnTANH))
