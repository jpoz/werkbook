...
var knownFunctions = [...]string{
	...
	"COUNTIF", "COUNTIFS", "DATE", "DATEVALUE", "DAY", "DAYS", "DEGREES", "EDATE", "EOMONTH",
	"ERROR.TYPE", "EVEN", "EXACT", "EXP", "FACT", "FIND", "FIXED", "FLOOR",
	"GCD", "HLOOKUP", "HOUR", "IF", "IFERROR", "IFNA", "IFS", "INDEX", "INDIRECT", "INT",
	"ISBLANK", "ISERR", "ISERROR", "ISEVEN", "ISLOGICAL", "ISNA", "ISNONTEXT", "ISODD", "ISNUMBER", "ISTEXT", "LARGE",
	"LCM", "LEFT", "LEN", "LN", "LOG", "LOG10", "LOOKUP", "LOWER", "MATCH", "MAX",
	"MAXIFS", "MEDIAN", "MID", "MIN", "MINIFS", "MINUTE", "MOD", "MONTH", "MROUND", "N", "NA",
	"NETWORKDAYS", "NOT", "NOW", "ODD", "OR",
	"PI", "POWER", "PRODUCT", "PROPER", "QUOTIENT", "RADIANS", "RAND", "RANDBETWEEN", "REPLACE",
	...
	"TYPE", "UPPER", "VALUE", "VLOOKUP", "WEEKDAY", "WEEKNUM", "XLOOKUP", "XOR", "YEAR",
}
