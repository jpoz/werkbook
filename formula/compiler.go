...
var knownFunctions = [...]string{
	...
	"COUNTIF", "COUNTIFS", "DATE", "DAY", "DAYS", "DEGREES", "EVEN", "EXACT", "EXP", "FACT", "FIND", "FLOOR",
	"GCD", "HLOOKUP", "HOUR", "IF", "IFERROR", "IFNA", "IFS", "INDEX", "INDIRECT", "INT",
	"ISBLANK", "ISERR", "ISERROR", "ISEVEN", "ISNA", "ISODD", "ISNUMBER", "ISTEXT", "LARGE",
	"LCM", "LEFT", "LEN", "LN", "LOG", "LOG10", "LOOKUP", "LOWER", "MATCH", "MAX",
	"MAXIFS", "MEDIAN", "MID", "MIN", "MINIFS", "MINUTE", "MOD", "MONTH", "MROUND", "N", "NA", "NOT", "NOW", "ODD", "OR",
	...
	"TYPE", "UPPER", "VALUE", "VLOOKUP", "WEEKDAY", "XLOOKUP", "XOR", "YEAR",
}
