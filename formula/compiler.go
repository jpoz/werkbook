...
var knownFunctions = [...]string{
	"ABS", "ACOS", "ACOSH", "ADDRESS", "AND", "ASIN", "ASINH", "ATAN", "ATAN2", "ATANH", "AVERAGE", "AVERAGEIF",
	...
	"SECOND", "SIGN", "SIN", "SINH", "SMALL", "SORT", "SQRT", "SQRTPI", "STDEV", "STDEVP", "SUBSTITUTE", "SUBTOTAL", "SUM", "SUMIF",
