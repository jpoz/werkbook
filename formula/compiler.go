...
var knownFunctions = [...]string{
	...
	"COUNTIF", "COUNTIFS", "CSC", "CSCH", "DATE", "DATEDIF", "DATEVALUE", "DAY", "DAYS", "DAYS360", "DECIMAL", "DEGREES", "DEVSQ", "EDATE", "EOMONTH",
	"ERROR.TYPE", "EVEN", "EXACT", "EXP", "FACT", "FACTDOUBLE", "FIND", "FIXED", "FLOOR",
	"GCD", "GEOMEAN", "HLOOKUP", "HOUR", "IF", "IFERROR", "IFNA", "IFS", "INDEX", "INDIRECT", "INT",
	...
	"MAXIFS", "MEDIAN", "MID", "MIN", "MINIFS", "MINUTE", "MOD", "MODE", "MONTH", "MROUND", "MULTINOMIAL", "N", "NA",
	...
	"SEC", "SECH", "SECOND", "SIGN", "SIN", "SINH", "SMALL", "SORT", "SQRT", "SQRTPI", "STDEV", "STDEVP", "SUBSTITUTE", "SUBTOTAL", "SUM", "SUMIF",
	"SUMIFS", "SUMPRODUCT", "SUMSQ", "SWITCH", "T", "TAN", "TANH", "TEXT", "TEXTJOIN", "TIME", "TODAY", "TRIM", "TRUNC",
...
var funcNameToID map[string]int

func init() {
	funcNameToID = make(map[string]int, len(knownFunctions))
	for i, name := range knownFunctions {
		funcNameToID[name] = i
	}
}
