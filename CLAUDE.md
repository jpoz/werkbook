...
# Run integration tests (requires LibreOffice installed)
...
Werkbook is a Go library for reading and writing Excel XLSX files. It is currently in Phase 1 (core read/write); the formula engine, streaming, and styles are not yet implemented. See `specs/architecture.md` for the full roadmap.
